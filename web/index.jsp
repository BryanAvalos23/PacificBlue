            ...
            <div class = "services-container">
                ...
                <article class = "service">
                    ...
                    <div class = "service-content">
                        <h2>Servicio a la habitaci�n y desayuno buffet</h2>
                        <p>Sabemos que un buen servicio de restaurante es algo primordial para cualquier hotel de prestigio y el nuestro no es la excepci�n, con la carta mas completa de entradas, platos principales y postres as� como una zona de bar para tu diversi�n.</p>
                    </div>
                </article>
                ...
                <article class = "service">
                    ...
                    <div class = "service-content">
                        ...
                        <p>No hay nada mejor para relajarse que un tiempo para poder nadar o simplemente tomar el sol junto a una piscina amplia lista para darse un chapuz�n, si no es de tu agrado nadar bajo el sol o el clima te ofrecemos una piscina interior climatizada lista para tu uso.</p>
                    </div>
                </article>
                <!-- end of single service -->
                <!-- single service -->
                <article class = "service">
                    ...
                    <div class = "service-content">
                        ...
                        <p>La limpieza es algo fundamental en nuestros establecimientos, tus habitaciones son aseadas de la mejor manera a diario respetando tu privacidad y siempre y cuando sea de tu elecci�n que sea as�, todas las habitaciones son completamente sanitizadas despues de que el usuario deja su uso.</p>
                    </div>
                </article>
                <!-- end of single service -->
                <!-- single service -->
                <article class = "service">
                    ...
                    <div class = "service-content">
                        <h2>Lo ultimo de tecnolog�a en seguridad.</h2>
                        <p>La seguridad es algo muy importante tanto como el confort del uso de ella, as� que implementamos un sistema biom�trico para que nadie mas que t� y los que tu elijas al momento del registro puedan entrar a tu habitaci�n de una manera sencilla y sin tarjetas o algun otra llave que pueda perderse en cualquier momento.</p>
                    </div>
                </article>
                <!-- end of single service -->
            </div>
